 ...
 * 
 * Simulates sending SMS notifications when a return request
 * status changes. Maintains a log of all sent notifications.
 */
public class SMSNotifier implements StatusObserver {
    ...
    public void update(ReturnRequest request, RequestStatus oldStatus, RequestStatus newStatus) {
        ...
        String message = String.format(
            "[%s] 📱 SMS to %s: Your return request %s has been updated to '%s' (Product: %s)",
            timestamp,
